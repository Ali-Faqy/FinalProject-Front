...
const adminName = "Ali Othman"
  ...
  const totalRevenue = "842,314";
  const totalOrders = "1,482";
  const totalProducts = "324";
  const totalCustomers = "5,783";
  const totalRevenueChange = "24";
  const totalOrdersChange = "12";
  const totalProductsChange = "8";
  const totalCustomersChange = "16";

  const orders = [
    {order_id: 45782, order_status: "Shipped", total_price: 24500, user_name: "Ali Othman" },
    {order_id: 45781, order_status: "Processing", total_price: 175000, user_name: "Amer Daglies" },
    {order_id: 45780, order_status: "Delivered", total_price: 8750, user_name: "Tasnim Ayed" },
  ];

  const topSellingProducts = [
    { id: 1, name: "Compact Tractor X200", category: "Tractors", price: 24500, stock: 15, sales: 124 },
    { id: 2, name: "Harvester Pro 5000", category: "Harvesters", price: 175000, stock: 8, sales: 42 },
    { id: 3, name: "Irrigation System", category: "Irrigation", price: 8750, stock: 32, sales: 87 },
    { id: 4, name: "Tractor X100", category: "Tractors", price: 15000, stock: 20, sales: 200 },
    { id: 5, name: "Seeder Pro 3000", category: "Seeders", price: 5000, stock: 50, sales: 300 },
    { id: 6, name: "Plow Master 400", category: "Plows", price: 12000, stock: 10, sales: 150 },
    { id: 7, name: "Fertilizer Spreader", category: "Fertilizers", price: 3000, stock: 25, sales: 180 },
    { id: 8, name: "Cultivator X500", category: "Cultivators", price: 8000, stock: 12, sales: 90 },
    { id: 9, name: "Irrigation Pump", category: "Irrigation", price: 2000, stock: 40, sales: 250 },
    { id: 10, name: "Harvesting Machine", category: "Harvesters", price: 50000, stock: 5, sales: 60 },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          >
            ...
            <div className="space-y-4">
                {orders.map((order) => (
                    <Link to={`/orders/${order.order_id}`} key={order.order_id} className="block">
